    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          <motion.div
            className="fixed top-14 right-5 z-50 w-64 rounded-2xl border border-white/[0.08] bg-white/[0.04] backdrop-blur-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.4)] overflow-hidden"
          ...
          >
            ...
            <div className="py-1.5">
              <button type="button" className="w-full px-4 py-2 text-left text-text-body text-xs font-sans hover:bg-white/[0.06] hover:text-text-headline transition-colors flex items-center gap-2.5">
